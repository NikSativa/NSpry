...
@testable import FakeifyMacro

final class FakeifyMacroTests {
    private let sut = ["Fakeify": FakeifyMacro.self]
    ...
    func testMacroWithpreprocessorFlagArgument() {
        ...
        assertMacroExpansion("""
                             @Fakeify(preprocessorFlag: "CUSTOM")
                             \(protocolDeclaration)
                             """,
                             expandedSource: """
                             \(protocolDeclaration)
    ...
    func testMacroWithpreprocessorFlagArgumentWithInterpolation() {
        ...
        assertMacroExpansion(#"""
                             @Fakeify(preprocessorFlag: "CUSTOM\(123)FLAG")
                             \#(protocolDeclaration)
                             """#,
                             expandedSource: """
    ...
    func testMacroWithpreprocessorFlagArgumentFromVariable() {
        ...
        assertMacroExpansion("""
                             ...
                             @Fakeify(preprocessorFlag: myCustomFlag)
                             \(protocolDeclaration)
                             """,
                             expandedSource: """
                             let myCustomFlag = "DEBUG"
